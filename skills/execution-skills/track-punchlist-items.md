...
|------------|---------|----------------|
| `project-database` | Primary punch list database with real-time tracking, filtering, and dashboard views | Create/update punch item records; Track status changes; Generate filtered views by system, classification, party; Support mobile data capture forms; Calculate real-time metrics; Generate dashboard components |
