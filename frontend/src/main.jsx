// build: 2026-04-30-multi-fixes-meeting
...
const CACHE_BUST_VERSION = '2026-04-29-30-pareto-jackknife-charts';
(async () => {
  try {
...
const PlanificadorAgent = lazyRetry(() => import('./pages/PlanificadorAgent'));
                        ...
                        <BrowserRouter>
                            <Routes>
                                ...
                                <Route element={<P roles={ALL}><App /></P>}>
                                    ...
                                    <Route path="planificador-agent" element={<S><PlanificadorAgent /></S>} />
