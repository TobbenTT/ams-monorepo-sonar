...
const CAPABILITIES = [
  ...
  { id: 33, layer: 6, name: 'RCM Strategy Advisor', icon: Sparkles, status: 'phase2',
    differential: 'Sugiere ajustar estrategia preventiva por equipo (frecuencia, tareas) basado en histórico',
    mageam: 'Claude analiza data Weibull + falla histórica → propone cambios' },
  { id: 34, layer: 6, name: 'Shift Handover Assistant', icon: UserCheck, status: 'phase2',
    differential: 'Resumen automático del turno saliente para el entrante (OTs, pendientes, alertas)',
    mageam: 'Claude consolida ejecución + observaciones + bloqueos' },
  { id: 35, layer: 6, name: 'Post-Maintenance Learning', icon: Brain, status: 'phase2',
    differential: 'Aprende del cierre de cada OT (causas, soluciones efectivas) y enriquece base conocimiento',
    mageam: 'Embedding + retrieval para troubleshooting futuro' },
  ...
  { id: 40, layer: 6, name: 'Knowledge Base Curator', icon: FileText, status: 'phase2',
    differential: 'IA mantiene actualizada la base de troubleshooting (cierres + RCAs + manuales)',
    mageam: 'Embedding + auto-tag + búsqueda semántica para mantenedor en terreno' },
